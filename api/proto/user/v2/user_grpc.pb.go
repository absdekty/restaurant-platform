...
const (
	UserService_RegisterUser_FullMethodName = "/user.v2.UserService/RegisterUser"
	UserService_LoginUser_FullMethodName    = "/user.v2.UserService/LoginUser"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/user/v2/user.proto",
}
